...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new JoystickButton(driverControl, Button.kL2.value)
        .whileTrue(new JoystickDriveReverse(drivetrain, xAxis, yAxis, thetaAxis));
    new JoystickButton(driverControl, Button.kShare.value)
        .onTrue(new InstantCommand(visionProcessor::limelightRetract));

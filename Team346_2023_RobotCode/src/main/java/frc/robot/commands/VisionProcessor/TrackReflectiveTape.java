...
public class TrackReflectiveTape extends SequentialCommandGroup {
  ...
  public TrackReflectiveTape() {
    if (RobotContainer.visionProcessor.isVisible() == true) {
      ...
      double x1 = RobotContainer.visionProcessor.distanceFromTargetX(Constants.HEIGHT_OF_TARGET1);
      double z1 = RobotContainer.visionProcessor.distanceFromTargetZ(Constants.HEIGHT_OF_TARGET1);
      Pose2d distance1 = new Pose2d(x1, z1, null);

      double x2 = RobotContainer.visionProcessor.distanceFromTargetX(Constants.HEIGHT_OF_TARGET2);
      double z2 = RobotContainer.visionProcessor.distanceFromTargetZ(Constants.HEIGHT_OF_TARGET2);

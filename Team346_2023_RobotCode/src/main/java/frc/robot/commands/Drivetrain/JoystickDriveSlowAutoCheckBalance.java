...
public class JoystickDriveSlowAutoCheckBalance  extends CommandBase {
...
double theta;
  ...
  public JoystickDriveSlowAutoCheckBalance(Drivetrain drivetrain, double x, double y, double theta) {

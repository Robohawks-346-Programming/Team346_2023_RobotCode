...
// public class TwoCubeOutBlue extends SequentialCommandGroup {

//     public TwoCubeOutBlue() {
//         addCommands(
...
//                         new DriveForTime(RobotContainer.drivetrain, -0.5, -0.03, 0))),
...
//                     new DriveForTime(RobotContainer.drivetrain, 0.75, -0.03, 0)),
//                 new InstantCommand(RobotContainer.drivetrain::brake),
